...
public class CavesSO : BaseGeneration
{
    ...
    public void GenerateCave(int width, int height, Vector2 originPoint, MyTilemap world)
    {
    ...
    void DrawCave(Vector2 pos, MyTilemap world)
    {
        for (int x = (int)pos.x; x < width; x++)
        {
            for (int y = (int)pos.y; y < height; y++)
    ...
    public void GenerateTunnels(MyTilemap world)
    {
    ...
    private void DrawTunnel(MyTilemap world)
    {
